...
def popular():
    ...
    # livros
    ci_livro("Dom Casmurro", "Machado de Assis", isbn="9788575412621", sinopse="Romence clássico", capa=None, quantidade=3, categoria_id=None)
    ...
    criar_reserva(2,2)
    # sugestão
    criar_sugestao("Livro Novo", "Autor X", "Ficção", "Seria bom ter este livro.", aluno_id=11)
    # histórico
    criar_historico(1,1)
    # relatório exemplo
